 ...
 */
final class Version20210402044047 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pret_article (pret_id INT NOT NULL, article_id INT NOT NULL, INDEX IDX_7000C1361B61704B (pret_id), INDEX IDX_7000C1367294869C (article_id), PRIMARY KEY(pret_id, article_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
